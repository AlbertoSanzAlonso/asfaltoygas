              ...
              <ul className="text-white/70 text-[10px] font-bold tracking-[0.2em] space-y-6 uppercase">
                ...
                <li>
                  <a
                    ...
                    className="hover:text-white transition-colors flex items-center justify-center lg:justify-start gap-4 text-white/70 text-[10px] font-bold tracking-[0.2em] uppercase leading-relaxed"
                  >
