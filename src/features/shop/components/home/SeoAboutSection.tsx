    ...
    <div className="max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-10">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="font-display text-xl md:text-2xl font-bold uppercase tracking-wide text-secondary mb-6">
          {BRAND.name} — tu tienda de equipamiento para motorista
        </h2>
        <div className="font-sans text-sm text-secondary/60 leading-relaxed space-y-4">
          <p>
En {BRAND.name} encontrarás cascos homologados ECE 22.06, equipaje, aceites, lubricantes
              y productos de mantenimiento de las mejores marcas del sector: HJC, AGV, Shoei, Nolan, Airoh y muchas más.
          </p>
          <p>
