          ...
          <div className="bg-white p-12 md:p-20 shadow-sm border border-secondary/3 space-y-12">
            ...
            <section className="space-y-6">
              ...
              <p className="text-secondary/80 leading-relaxed">
                El presente Aviso Legal regula el acceso y uso del sitio web <a href={BRAND.url} className="text-primary hover:underline">{BRAND.url}</a>, cuyo titular es {legal.holderName}.
              </p>
              <p className="text-secondary/80 leading-relaxed">
            ...
            <section className="space-y-6">
              ...
              <p className="text-secondary/80 leading-relaxed">
                Todos los contenidos del sitio web (textos, imágenes, diseños, logotipos, estructura, código fuente, etc.) son titularidad de {legal.holderName} o dispone de los derechos necesarios para su uso.
              </p>
            ...
            <section className="space-y-6">
              ...
              <p className="text-secondary/80 leading-relaxed">
                {legal.holderName} no se hace responsable de los daños derivados del uso indebido del sitio web ni de posibles errores técnicos o interrupciones del servicio.
              </p>
            </section>
